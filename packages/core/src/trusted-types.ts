...
export const _ttPolicy: TTPolicy = (typeof trustedTypes !== 'undefined' && trustedTypes.createPolicy)
...
export const _rawPolicy: TTPolicy = (typeof trustedTypes !== 'undefined' && trustedTypes.createPolicy)
...
(function patchHTMLSetters() {
    ...
    Object.defineProperty(Element.prototype, 'innerHTML', {
      set(val: unknown) {
        if (typeof val === 'string') {
          _origInner.set!.call(this, _rawPolicy!.createHTML(val) as unknown as string);
        } else {
          _origInner.set!.call(this, val as string);
        }
      },
      get() { return _origInner.get!.call(this); },
      configurable: true,
    });
  }
  ...
  if (_origOuter?.set && _origOuter.get) {
    Object.defineProperty(Element.prototype, 'outerHTML', {
      set(val: unknown) {
        if (typeof val === 'string') {
          _origOuter.set!.call(this, _rawPolicy!.createHTML(val) as unknown as string);
        } else {
          _origOuter.set!.call(this, val as string);
        }
      },
      get() { return _origOuter.get!.call(this); },
      configurable: true,
    });
  }
})();
